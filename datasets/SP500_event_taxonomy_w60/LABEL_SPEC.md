...
This dataset was generated with a lookback window of 60 trading days.
...
## Label Definitions
- jump: positive return shock relative to the trailing 60-day baseline
- drop: negative return shock relative to the trailing 60-day baseline
- volume_spike: abnormal log-volume surge relative to the trailing 60-day baseline
- volatility_shock: realized-volatility surge relative to the trailing 60-day baseline
