...
This dataset was generated with a lookback window of 50 trading days.
...
## Label Definitions
- jump: positive return shock relative to the trailing 50-day baseline
- drop: negative return shock relative to the trailing 50-day baseline
- volume_spike: abnormal log-volume surge relative to the trailing 50-day baseline
- volatility_shock: realized-volatility surge relative to the trailing 50-day baseline
