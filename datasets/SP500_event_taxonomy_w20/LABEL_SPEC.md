...
This dataset was generated with a lookback window of 20 trading days.
...
## Label Definitions
- jump: positive return shock relative to the trailing 20-day baseline
- drop: negative return shock relative to the trailing 20-day baseline
- volume_spike: abnormal log-volume surge relative to the trailing 20-day baseline
- volatility_shock: realized-volatility surge relative to the trailing 20-day baseline
