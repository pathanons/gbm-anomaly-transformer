...
from src.gbm.data import get_run_dir, save_joint_manifest, set_seed
from src.gbm.device import resolve_device
from src.gbm.io import save_json
from src.gbm.runtime import build_gbm_model, build_runtime_loaders
from src.gbm.training import run_gbm_epoch
...
def main() -> None:
    ...
    parser.add_argument("--loss-mode", default="legacy", choices=["legacy", "refactored"])
