...
- `best_model_suite.yaml`: one-command dry-run/long-run suite for current best-known NLL + association model, hyperparameter grid, seed-based CV proxy, and MAD k sweep from 9 upward.
